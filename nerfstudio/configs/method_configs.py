...
descriptions = {
    ...
    "depth-nerfacto-simplePixelSampler": "Nerfacto with depth supervision, and simplePixelSampler.",
...
method_configs["depth-nerfacto-simplePixelSampler"] = TrainerConfig(
    method_name="depth-nerfacto-simplePixelSampler",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
